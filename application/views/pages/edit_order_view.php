                        ...
                        <div class="offset-md-1">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input class="" type="text" name="完稅價" id="" value="<?php echo $result[0]['完稅價']; ?>" ></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="" type="text" name="盤價" id="" value="<?php echo $result[0]['盤價']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td><?php echo form_error('匯款金額'); ?></td>
                                    <td><label for="" class="">匯款金額</label></td>
                                    <td><input class="" type="text" name="匯款金額" id="" value="<?php echo $result[0]['匯款金額']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td><?php echo form_error('匯款銀行'); ?></td>
                                    <td><label for="" class="">匯款銀行</label></td>
                                    <td><input class="" type="text" name="匯款銀行" id="" value="<?php echo $result[0]['匯款銀行']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td><input class="" type="text" name="匯款戶名" id="" value="<?php echo $result[0]['匯款戶名']; ?>" required></td>
                                </tr>
                                <!-- <tr>
